...
plt.title("Разница средней температуры (2024 – 2021)")
plt.xlabel("Дата")
plt.ylabel("ΔT, °C")
plt.legend()
plt.grid(True)
...
plt.axhline(0, color='black', linestyle='--')
plt.title("Скорость прогрева воздуха (dT/dt): 2024 vs 2021")
plt.xlabel("Дата")
...
plt.title("Первая дата перехода температуры > 0°C по станциям")
plt.xlabel("Регион")
plt.ylabel("Дата")
plt.legend()
plt.grid(True)
...
plt.title("Heatmap: средняя температура по месяцам, регионам и годам")
